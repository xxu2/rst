              <form action="../inconstruction.php" method="post">
                ...
                <tr>
                <td class="left_col">Particle shape &nbsp;&nbsp;:</td>
                <td class="right_col">
                        <SELECT id='select2' name='select2'>
                        <option value='1' selected>1: Spheroid</option>";
                        <option value='2'>2: Cylinder</option>";
                        </SELECT></td>
                </tr>
                <tr>
                <td class="left_col">Aspect ratio &nbsp;&nbsp;:</td>
                <td class="right_col"> <input type="text" name="number9" id="num9" value="1.0" size="10"/></td> 
                </tr>
                <tr>
