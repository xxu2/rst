...
<?php include 'include/header.php'; ?>
        ...
        <div id="calc" style="border:1px solid <?php echo getbordercolor() ?>;height:680px;">
                ...
                <div class="cleaner darkliner" style="margin:20px 0 10px 0;"> </div>
                <p style="text-align:justify;">REMOTE SENSING (RS) TOOLKIT is a website founded by Xiaoguang Xu on December 2013. It aims to provide radiation calculators for simple web-based calculation, so that users do not need to download and compile those programs. Because just started, we are currently working hard to develope the web-based interface for planed calculator.</p>

                 <br>
                <h3>TEAM</h3>
                <div class="cleaner darkliner"> </div>
                <a href="http://eas.unl.edu/~xxu" target="_blank">Xiaoguang Xu (Richard)</a> <br><br>
                <a href="http://eas.unl.edu/~ywang" target="_blank">Yi Wang</a> <br><br>
                <a href="http://zyang01.com" target="_blank">Zhifeng Yang (Bruce)</a> <br><br>
                <br><br><br>
